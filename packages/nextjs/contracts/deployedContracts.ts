...
const deployedContracts = {
  1135: {
    ...
    Torito: {
      address: "0xbe22EE3537A64f49dbA52FaeD71FCCd5E85D2884", // ⚠️ REEMPLAZAR CON LA DIRECCIÓN REAL DEL CONTRATO DESPLEGADO
      abi: [
        {
          type: "constructor",
          inputs: [
        ...
        },
        {
          ...
          inputs: [{ name: "currency", type: "bytes32", internalType: "bytes32" }],
          outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
          stateMutability: "view",
        },
        {
  ...
  31337: {
    // Hardhat local network para desarrollo
    Torito: {
      address: "0x5FbDB2315678afecb367f032d93F642f64180aa3", // Dirección típica del primer contrato en Hardhat
      abi: [
        {
          type: "constructor",
          inputs: [
